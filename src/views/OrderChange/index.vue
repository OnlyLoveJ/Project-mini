<template>
  <div class="wrap">
    <div class="Order">
      <!-- 添加订单区域 -->
      <el-divider class="width:100%" content-position="left">变更前</el-divider>
      <el-form
        :model="ruleForm"
        :rules="rules"
        ref="ruleForm"
        ...
        inline
      >
        <el-form-item label="姓名" style="width:30%" prop="name">凉凉</el-form-item>
        <el-form-item label="电话" style="width:30%" prop="name">18937827918</el-form-item>
        <el-form-item label="企业名称" style="width:30%" prop="name">百度</el-form-item>
        <el-form-item label="订单金额" style="width:30%" prop="name">￥10800.00</el-form-item>
        <el-form-item label="已付金额" style="width:30%" prop="name">￥8888</el-form-item>
    ...
    <div class="Order">
      <!-- 添加订单区域 -->
      <el-divider class="width:100%" content-position="left">变更后</el-divider>
      <el-form
        :model="ruleForm"
        :rules="rules"
        ref="ruleForm"
      ...
      >
        ...
        <el-form-item label="商品信息" class="w-100" prop="region">
          <el-button type="primary" size="mini" plain @click="showAddGoods">
            添加商品
